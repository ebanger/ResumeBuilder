 ...
 */
function btp_precontent_strip_shortcode( $content ){	
...
add_filter( 'the_content', 'btp_precontent_strip_shortcode', 5 );
...
function btp_precontent_capture() {
	...
	/* Disable stripping the precontent shortcode */
	remove_filter( 'the_content', 'btp_precontent_strip_shortcode', 5 );
	...
	/* Enable stripping the precontent shortcode */
	add_filter( 'the_content', 'btp_precontent_strip_shortcode', 5 );
